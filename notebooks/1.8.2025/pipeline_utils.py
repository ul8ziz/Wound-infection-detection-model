...
def get_transforms(train: bool = True, image_size: Tuple[int, int] = (512, 512)):
    """
...
def create_dataset(root: str, annotation_file: str, train: bool = True, image_size: Tuple[int, int] = (512, 512)) -> Dataset:
    """
